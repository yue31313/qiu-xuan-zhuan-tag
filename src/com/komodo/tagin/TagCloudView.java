...
//    }
	...
	public boolean onTouchEvent(MotionEvent e) {
		float x = e.getX();
        float y = e.getY();
//      Log.e("aaabbb", "motion:x=["+x+"] y=["+y+"] action is ["+e.getAction()+"]");
        switch (e.getAction()) {
        case MotionEvent.ACTION_DOWN:
            oldX = x;
            oldY = y;
//            Log.e("aaaccc", "motion:x=["+x+"] y=["+y+"] action is ["+e.getAction()+"]");
            break;
...
//            Log.e("aaaddd", "motion:dx=["+dx+"] dy=["+dy+"] action is ["+e.getAction()+"]");
...
//			return "http://"+url;
	...
	View.OnClickListener OnTagClickListener(final String url ,final Context context){
